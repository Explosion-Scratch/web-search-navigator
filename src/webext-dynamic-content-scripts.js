...
(function () {
  ...
  async function executeFunction(target, function_, ...args) {
    ...
    if (gotScripting) {
      ...
      return injection === null || injection === void 0
        ? void 0
        : injection.result;
    }
  ...
  async function executeScript({
    ...
    for (let content of files) {
      ...
      if (gotScripting) {
        if ('code' in content) {
          throw new Error(
            'chrome.scripting does not support injecting strings of `code`',
          );
        }
  ...
  async function injectContentScript(target, scripts) {
    ...
    for (const script of castArray(scripts)) {
      insertCSS({
        ...
        runAt:
          (_c = script.runAt) !== null && _c !== void 0 ? _c : script.run_at,
      });
      void executeScript({
        tabId,
        frameId,
        ...
        matchAboutBlank:
          (_e = script.matchAboutBlank) !== null && _e !== void 0
            ...
            : script.match_about_blank,
        runAt:
          (_f = script.runAt) !== null && _f !== void 0 ? _f : script.run_at,
      });
    }
  ...
  async function registerContentScript$1(contentScriptOptions, callback) {
    ...
    const excludeMatchesRegex = patternToRegex(
      ...(excludeMatches !== null && excludeMatches !== void 0
        ? excludeMatches
        : []),
    );
